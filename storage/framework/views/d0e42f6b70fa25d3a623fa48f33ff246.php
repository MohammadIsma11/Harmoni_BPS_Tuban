...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="<?php echo e(asset('img/logo_harmoni.png')); ?>" alt="Logo Harmoni" class="me-2">
                <div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a class="nav-link btn-login-nav" href="<?php echo e(route('login')); ?>">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 d-none d-lg-block text-center">
                    <img src="<?php echo e(asset('video/call-center.gif')); ?>" alt="Hero Illustration" class="img-fluid animate-up rounded-5 shadow-sm" style="max-height: 380px; object-fit: cover;">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <a href="<?php echo e(route('ticket.public.create')); ?>" class="btn btn-action btn-ticket-action">Buat Tiket Baru</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <a href="<?php echo e(route('kms.public.index')); ?>" class="btn btn-action btn-kms-action">Buka Knowledge Base</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="service-card">
                        ...
                        <a href="<?php echo e(route('ticket.public.track.form')); ?>" class="btn btn-action" style="background: #f59e0b; color: white; border: none;">Cek Progres Laporan</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="kms-section" id="kms">
        <div class="container">
            <div class="d-flex justify-content-between align-items-end mb-5">
                ...
                <a href="<?php echo e(route('kms.public.index')); ?>" class="btn btn-link text-primary fw-bold text-decoration-none">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card article-card h-100 border-0">
                        <div class="card-body p-4">
                            <small class="text-primary fw-bold mb-2 d-block"><?php echo e($article->category->name); ?></small>
                            <h6 class="fw-bold mb-3"><?php echo e($article->title); ?></h6>
                            <p class="text-muted small mb-4"><?php echo e(Str::limit(strip_tags($article->content), 80)); ?></p>
                            <a href="<?php echo e(route('kms.public.show', $article->slug)); ?>" class="btn btn-link text-primary p-0 small text-decoration-none fw-bold">
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="footer-logo d-flex align-items-center">
                        <img src="<?php echo e(asset('img/logo_harmoni.png')); ?>" alt="Logo">
                        <div class="ms-3">
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <a href="<?php echo e(route('kms.public.index')); ?>" class="footer-link">E-Library</a>
                    <a href="<?php echo e(route('login')); ?>" class="footer-link text-primary fw-bold">Login Internal</a>
                </div>
                <div class="col-lg-3">
    ...
    <button type="button" class="floating-wa shadow-lg border-0 animate-up" data-bs-toggle="modal" data-bs-target="#consultationModal">
