    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card p-4 p-md-5">
                ...
                <form action="<?php echo e(route('ticket.public.store')); ?>" method="POST" enctype="multipart/form-data" id="ticket-form">
                    <?php echo csrf_field(); ?>
                    
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-primary text-uppercase">Nama Pelapor</label>
                            <input type="text" name="reporter_name" id="reporter_name" value="<?php echo e(old('reporter_name')); ?>" required class="form-control rounded-4 p-3 bg-light border-0" placeholder="Nama Lengkap">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-primary text-uppercase">WhatsApp Aktif</label>
                            <input type="text" name="reporter_phone" id="reporter_phone" value="<?php echo e(old('reporter_phone')); ?>" required class="form-control rounded-4 p-3 bg-light border-0" placeholder="0812XXXXXXXX">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-primary text-uppercase">Email (Opsional)</label>
                            <input type="email" name="reporter_email" id="reporter_email" value="<?php echo e(old('reporter_email')); ?>" class="form-control rounded-4 p-3 bg-light border-0" placeholder="alamat@email.com">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="reporter_organization" id="reporter_organization" value="<?php echo e(old('reporter_organization')); ?>" required class="form-control rounded-4 p-3 bg-light border-0" placeholder="Contoh: BPS Kabupaten Tuban">
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="category_id" id="category_id" required class="form-select rounded-4 p-3 bg-light border-0">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" data-name="<?php echo e($category->name); ?>" <?php echo e(old('category_id') == $category->id ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="priority" required class="form-select rounded-4 p-3 bg-light border-0">
                                <option value="rendah" <?php echo e(old('priority') == 'rendah' ? 'selected' : ''); ?>>Rendah (Bisa Ditunggu)</option>
                                <option value="sedang" <?php echo e(old('priority', 'sedang') == 'sedang' ? 'selected' : ''); ?>>Sedang (Normal)</option>
                                <option value="tinggi" <?php echo e(old('priority') == 'tinggi' ? 'selected' : ''); ?>>Tinggi (Mendesak)</option>
                            </select>
                        </div>
                        <div class="col-12">
                            <label class="form-label small fw-bold text-primary text-uppercase">Subjek Laporan</label>
                            <input type="text" name="subject" id="subject" value="<?php echo e(old('subject')); ?>" required class="form-control rounded-4 p-3 bg-light border-0" placeholder="Garis besar kendala...">
                        </div>
                        <div class="col-12">
                            <label class="form-label small fw-bold text-primary text-uppercase">Penjelasan Detail</label>
                            <textarea name="description" id="description" rows="5" required class="form-control rounded-4 p-3 bg-light border-0" placeholder="Jelaskan secara rinci agar cepat ditangani..."><?php echo e(old('description')); ?></textarea>
                        </div>
                        <div class="col-12">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ticket/public/create.blade.php ENDPATH**/ ?>