...
<body>
    ...
    <table class="table-laporan">
        <tr>
            ...
            <td class="content"><strong><?php echo e($agenda->title); ?></strong></td>
        </tr>
        <tr>
            <td class="label">Nama Pegawai</td>
            <td class="separator">:</td>
            <td class="content"><?php echo e($agenda->assignee->nama_lengkap); ?></td>
        </tr>
        <tr>
            <td class="label">Nomor Surat Tugas</td>
            <td class="separator">:</td>
            <td class="content"><?php echo e($agenda->nomor_surat_tugas ?? '-'); ?></td>
        </tr>
        <tr>
            <td class="label">Tujuan / Lokasi</td>
            <td class="separator">:</td>
            <td class="content"><?php echo e($report->lokasi_tujuan); ?></td>
        </tr>
        <tr>
            <td class="label">Waktu Pelaksanaan</td>
            <td class="separator">:</td>
            <td class="content"><?php echo e(\Carbon\Carbon::parse($report->tanggal_lapor)->translatedFormat('l, d F Y')); ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="separator">:</td>
            <td class="content"><?php echo formatNumberedList($details['aktivitas'] ?? $agenda->aktivitas); ?></td>
        </tr>
        <tr>
            <td class="label">Permasalahan ditemui</td>
            <td class="separator">:</td>
            <td class="content"><?php echo formatNumberedList($details['permasalahan'] ?? $agenda->permasalahan); ?></td>
        </tr>
        <tr>
            <td class="label">Solusi / Langkah Antisipatif</td>
            <td class="separator">:</td>
            <td class="content"><?php echo formatNumberedList($details['solusi_antisipasi'] ?? $agenda->solusi_antisipasi); ?></td>
        </tr>
    </table>

    <div class="signature-wrapper" style="margin-top: 50px;">
        <div class="signature-box">
            Tuban, <?php echo e(\Carbon\Carbon::now()->translatedFormat('d F Y')); ?><br>
            Pegawai yang melakukan perjalanan,<br><br><br><br><br><br><br>
            <strong><?php echo e($agenda->assignee->nama_lengkap); ?></strong>
        </div>
        <div class="clear"></div>
    </div>


    <?php if($agenda->photos->count() > 0): ?>
    <div class="page-break"></div>
    <div class="photo-header">DOKUMENTASI KEGIATAN</div>
    
    <table class="photo-table">
        <?php $__currentLoopData = $agenda->photos->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td class="photo-td">
                <div style="height: 280px; display: flex; align-items: center; justify-content: center; overflow: hidden; border: 1px solid #eee;">
                    <img src="<?php echo e(public_path('storage/' . $p->photo_path)); ?>" style="max-height: 100%; max-width: 100%; width: auto; height: auto;">
                </div>
                <div class="photo-caption">Gbr: Dokumentasi Lapangan</div>
            </td>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($chunk->count() == 1): ?> <td style="width:50%;"></td> <?php endif; ?>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </table>
    <?php endif; ?>
...
</html><?php /**PATH /var/www/resources/views/history/pdf.blade.php ENDPATH**/ ?>