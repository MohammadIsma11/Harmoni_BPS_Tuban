        ...
        <div class="col-lg-6 text-center">
            <div class="card p-5">
                ...
                <div class="bg-light p-4 rounded-4 mb-4">
                    ...
                    <div class="h3 fw-bold text-primary mb-0" style="letter-spacing: 2px;"><?php echo e($tracking_id); ?></div>
                </div>
                ...
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('ticket.public.track.form')); ?>" class="btn btn-primary py-3 rounded-pill fw-bold">
                        <i class="fas fa-search me-2"></i> Lacak Sekarang
                    </a>
                    <a href="<?php echo e(route('ticket.public.create')); ?>" class="btn btn-outline-secondary py-3 rounded-pill fw-bold border-0">
                        Buat Laporan Lain
                    </a>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const newId = "<?php echo e($tracking_id); ?>";
        const newToken = "<?php echo e($token); ?>";
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ticket/public/success.blade.php ENDPATH**/ ?>