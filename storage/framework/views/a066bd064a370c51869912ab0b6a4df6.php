        ...
        <div class="col-lg-6 col-md-8">
            <div class="card card-presensi">
                <div class="header-presensi">
                    <a href="<?php echo e(route('meeting.index')); ?>" class="btn btn-link text-white text-decoration-none p-0 mb-3 small d-flex align-items-center justify-content-center">
