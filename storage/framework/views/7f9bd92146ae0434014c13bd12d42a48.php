                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-4 pt-3 border-top d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <div class="fw-bold small"><?php echo e(date('d M Y')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <form id="form-unified">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" id="in-tanggal" class="form-control rounded-3 py-2 px-3 mb-2" value="<?php echo e(date('Y-m-d')); ?>" required>
                                                </div>
                                                <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    <input type="text" class="form-control rounded-3 py-2 px-3 bg-light" value="<?php echo e(Auth::user()->nama_lengkap); ?>" readonly>
...
$(document).ready(function() {
    ...
    function initMaps() {
        ...
        Promise.all([
            ...
            fetch('<?php echo e(asset("geojson/peta_sls_202513523.geojson")); ?>').then(r => r.json()),
            $.get('<?php echo e(route("tematik.api.users")); ?>')
    ...
    function refreshAllData() {
        // Markers
        $.get('<?php echo e(route("tematik.api.lokasi")); ?>', function(res) {
        ...
        $.get('<?php echo e(route("tematik.api.info")); ?>', function(res) {
            let html = '';
            barChartLabels = [];
            barChartData = [];
            res.forEach(r => {
        ...
        // Laporan Table
        $.get('<?php echo e(route("tematik.api.laporan")); ?>', function(res) {
            let html = '';
            res.forEach(r => {
                html += `
                    <tr>
    ...
    $('#form-unified').on('submit', function(e) {
        ...
        const payload = {
            ...
            pic: <?php echo json_encode(Auth::user()->nama_lengkap); ?>,
        ...
        const request = isEdit
            ? $.ajax({ url: `<?php echo e(url('tematik/api/lokasi')); ?>/${id}`, type: 'PUT', data: payload })
            : $.post('<?php echo e(route("tematik.api.store")); ?>', payload);
    ...
    $('#confirm-delete').on('click', function() {
        ...
        $.ajax({
            url: `<?php echo e(url('tematik/api/lokasi')); ?>/${id}`, type: 'DELETE', data: { _token: '<?php echo e(csrf_token()); ?>' },
            success: function() { 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/tematik/index.blade.php ENDPATH**/ ?>