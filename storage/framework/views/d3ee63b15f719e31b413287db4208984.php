...
<head>
    ...
    <title><?php echo e($title ?? 'SEpintu - BPS Kabupaten Tuban'); ?></title>
...
<body>
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/">
                <img src="<?php echo e(asset('img/logo-bps.png')); ?>" alt="Logo" class="me-2" onerror="this.src='https://upload.wikimedia.org/wikipedia/commons/2/28/Lambang_Badan_Pusat_Statistik_%28BPS%29_Indonesia.svg'">
                <div class="lh-1">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link px-3 fw-medium" href="<?php echo e(route('ticket.public.create')); ?>">Buat Tiket</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 fw-medium" href="<?php echo e(route('ticket.public.index')); ?>">Tiket Saya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 fw-medium" href="<?php echo e(route('ticket.public.track.form')); ?>">Lacak Tiket</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3 fw-medium" href="<?php echo e(route('kms.public.index')); ?>">Knowledge Base</a>
                    </li>
    ...
    <footer class="footer">
        <div class="container text-center">
            <p class="mb-0 text-muted small">&copy; <?php echo e(date('Y')); ?> Badan Pusat Statistik Kabupaten Tuban. Hak Cipta Dilindungi.</p>
        </div>
    </footer>
