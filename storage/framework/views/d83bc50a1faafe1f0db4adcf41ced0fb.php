            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                <div class="bg-bps-blue p-3 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <a href="<?php echo e(route('task.index')); ?>" class="btn btn-outline-light btn-sm rounded-pill me-3 px-3">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 border-start border-4 border-primary">
                            ...
                            <div class="mb-0">
                                ...
                                <input type="text" name="sls" id="sls" class="form-control rounded-3 border-0 bg-light p-3 fw-bold shadow-sm" placeholder="Contoh: RT 02 / RW 01" value="<?php echo e(old('sls')); ?>">
                            </div>
