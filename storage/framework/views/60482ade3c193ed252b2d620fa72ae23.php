                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-center">
                        ...
                        <form action="<?php echo e(route('ticket.admin.push', $ticket->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="button" class="btn btn-success w-100 py-3 rounded-pill fw-bold text-uppercase shadow-sm btn-push-kms" data-subject="<?php echo e($ticket->subject); ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-push-kms').on('click', function(e) {
            ...
            $.get("<?php echo e(route('ticket.admin.check-kms-duplicate')); ?>", { subject: subject }, function(data) {
