...
<link rel="stylesheet" href="<?php echo e(asset('css/pages/assignment-create.css')); ?>">

<div class="container-fluid px-4 pb-5">
    <div class="mb-4 mt-3">
        <a href="<?php echo e(route('assignment.index')); ?>" class="btn btn-light btn-sm rounded-pill px-3 fw-bold text-muted shadow-sm">
            <i class="fas fa-arrow-left me-1"></i> Kembali ke Daftar
        </a>
    </div>

    <form id="formAssignment" action="<?php echo e(route('assignment.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row g-4">
    ...
    <div class="p-3 bg-white border rounded-4 shadow-sm">
        ...
        <div id="reviewer-container" style="display: none;" class="mb-3">
            ...
            <select name="reviewer_id" id="reviewer_id" class="form-select">
                ...
                <?php $__currentLoopData = $katims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($k->id); ?>"><?php echo e($k->nama_lengkap); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div>
            ...
            <select name="approver_id" id="approver_id" class="form-select">
                ...
                <?php $__currentLoopData = $kepalas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($k->id); ?>"><?php echo e($k->nama_lengkap); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
    </div>
</div>
                    ...
                    <div class="user-selection-container shadow-sm mb-4 border rounded-3 overflow-hidden">
                        <div class="user-selection-box" style="max-height: 600px; overflow-y: auto;" id="petugasList">
                            ...
                            <?php if($akunKhusus): ?>
                                ...
                                <div class="user-item petugas-row" onclick="togglePetugas(this, event)" data-id="<?php echo e($akunKhusus->id); ?>" data-name="<?php echo e($akunKhusus->nama_lengkap); ?>">
                                    <input type="checkbox" name="assigned_to[]" value="<?php echo e($akunKhusus->id); ?>" class="user-check d-none">
                                    <div class="custom-chk"></div>
                                    <span class="user-name small fw-bold text-primary"><?php echo e($akunKhusus->nama_lengkap); ?> (<?php echo e($akunKhusus->username); ?>)</span>
                                    <span class="status-badge is-busy-text d-none" id="status_busy_<?php echo e($akunKhusus->id); ?>">Ada Agenda</span>
                                    <span class="status-badge is-leave-text d-none" id="status_leave_<?php echo e($akunKhusus->id); ?>">Sedang Cuti</span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="user-group-label px-3 py-2 bg-light border-bottom border-top small fw-bold text-muted"><?php echo e($label); ?></div>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="user-item petugas-row" onclick="togglePetugas(this, event)" data-id="<?php echo e($u->id); ?>" data-name="<?php echo e($u->nama_lengkap); ?>">
                                        <input type="checkbox" name="assigned_to[]" value="<?php echo e($u->id); ?>" class="user-check d-none">
                                        <div class="custom-chk"></div>
...
<script>
    window.checkAvailabilityRoute = "<?php echo e(route('assignment.check-availability')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/assignment/create.blade.php ENDPATH**/ ?>