            ...
            <div id="tickets-container">
                ...
                <div class="card border-0 shadow-sm rounded-4 d-none" id="empty-state">
                    <div class="card-body p-5 text-center">
                        ...
                        <a href="<?php echo e(route('ticket.public.create')); ?>" class="btn btn-primary rounded-pill px-4 fw-bold">
                            Buat Tiket Baru
                        </a>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function refreshTickets() {
        ...
        fetch("<?php echo e(route('ticket.public.index')); ?>?" + items, {
                            ...
                            <div class="card h-100 border-0 shadow-sm rounded-4 hover-up transition-all">
                                <div class="card-body p-4">
                                    ...
                                    <div class="border-top pt-3 mt-auto">
                                        <a href="<?php echo e(url('tickets/track')); ?>?tracking_id=${ticket.tracking_id}" class="btn btn-outline-primary btn-sm w-100 rounded-pill fw-bold">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ticket/public/index.blade.php ENDPATH**/ ?>