...
<head>
    ...
    <title>BAST - <?php echo e($penugasan->no_bast); ?></title>
    <style>
...
<body>
    ...
    <div class="page">
        <div class="header text-center">
            ...
            <div class="fw-bold">NOMOR: <?php echo e($penugasan->no_bast ?: '.../3523/BAST/'.Carbon\Carbon::now()->month.'/2026'); ?></div>
        </div>

        <?php \Carbon\Carbon::setLocale('id'); ?>
        <p>Pada hari ini, <b><?php echo e(Carbon\Carbon::now()->isoFormat('dddd')); ?></b> tanggal <b><?php echo e(Carbon\Carbon::now()->isoFormat('D')); ?></b> bulan <b><?php echo e(Carbon\Carbon::now()->isoFormat('MMMM')); ?></b> tahun <b>Dua Ribu Dua Puluh Enam</b>, kami yang bertanda tangan di bawah ini:</p>

        <table style="width: 100%; border: none; margin-bottom: 1rem;">
            <tr>
                <td style="width: 30px; vertical-align: top;">1.</td>
                <td style="width: 120px;">Nama</td>
                <td>: <b><?php echo e($penugasan->mitra->nama_lengkap); ?></b></td>
            </tr>
            <tr>
                <td></td>
                <td>Sobat ID</td>
                <td>: <?php echo e($penugasan->mitra_id); ?></td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td>Nama</td>
                <td>: <b><?php echo e($katim->nama_lengkap); ?></b></td>
            </tr>
            <tr>
                <td></td>
                <td>Jabatan</td>
        ...
        <p><b>PIHAK PERTAMA</b> menyatakan telah menyelesaikan dan menyerahkan hasil pekerjaan kepada <b>PIHAK KEDUA</b>, dan <b>PIHAK KEDUA</b> menyatakan telah menerima hasil pekerjaan dari <b>PIHAK PERTAMA</b> sesuai dengan Perjanjian Kerja Nomor: <?php echo e($penugasan->no_spk ?: '................'); ?> dengan rincian sebagai berikut:</p>
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">Rp <?php echo e(number_format($p->total_honor_tugas, 0, ',', '.')); ?></td>
                </tr>
        ...
        <table class="signature-grid">
            <tr>
                <td>
                    ...
                    <p class="text-uppercase fw-bold"><?php echo e($penugasan->mitra->nama_lengkap); ?></p>
                </td>
                <td>
                    <p class="fw-bold">PIHAK KEDUA,</p>
                    <div style="height: 2.5cm;"></div>
                    <p class="text-uppercase fw-bold"><?php echo e($katim->nama_lengkap); ?></p>
                </td>
            </tr>
        </table>
    </div>
...
<?php /**PATH /var/www/resources/views/penugasan-mitra/bast.blade.php ENDPATH**/ ?>