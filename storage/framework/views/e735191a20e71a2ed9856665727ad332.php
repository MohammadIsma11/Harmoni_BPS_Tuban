...
<head>
    ...
    <title>SPK - <?php echo e($penugasan->no_spk); ?></title>
    <style>
        /* Document Setup */
...
<body>
    ...
    <div class="page page-break">
        <div class="header text-center">
            ...
            <div class="fw-bold" style="font-size: 12pt;">NOMOR: <?php echo e($penugasan->no_spk ?: '.../3523/SPK/'.Carbon\Carbon::now()->month.'/2026'); ?></div>
        </div>

        <?php \Carbon\Carbon::setLocale('id'); ?>
        <p>Pada hari ini, <b><?php echo e(Carbon\Carbon::parse($penugasan->tgl_mulai)->isoFormat('dddd')); ?></b> tanggal <b><?php echo e(Carbon\Carbon::parse($penugasan->tgl_mulai)->isoFormat('D')); ?></b> bulan <b><?php echo e(Carbon\Carbon::parse($penugasan->tgl_mulai)->isoFormat('MMMM')); ?></b> tahun <b>Dua Ribu Dua Puluh Enam</b> bertempat di Kabupaten Tuban, yang bertanda tangan di bawah ini:</p>

        <table style="width: 100%; border: none; margin: 1rem 0;">
            <tr>
                <td style="width: 30px; vertical-align: top;">(1)</td>
                <td class="text-justify"><?php echo e($katim->nama_lengkap ?? '.......................'); ?> : Badan Pusat Statistik Kabupaten Tuban, berkedudukan di Tuban, bertindak untuk dan atas nama Badan Pusat Statistik Jl. Dr. Wahidin Sudirohusodo No.8, Tuban, selanjutnya disebut sebagai <b>PIHAK PERTAMA</b>.</td>
            </tr>
            <tr style="height: 10px;"><td></td><td></td></tr>
            <tr>
                <td style="width: 30px; vertical-align: top;">(2)</td>
                <td class="text-justify"><?php echo e($penugasan->mitra->nama_lengkap); ?> : Petugas Pendataan Lapangan, berkedudukan di <?php echo e($penugasan->lokasi_tugas ?? 'Kabupaten Tuban'); ?>, bertindak untuk dan atas nama diri sendiri, selanjutnya disebut sebagai <b>PIHAK KEDUA</b>.</td>
            </tr>
        </table>

        <p>bahwa <b>PIHAK PERTAMA</b> dan <b>PIHAK KEDUA</b> yang secara bersama-sama disebut <b>PARA PIHAK</b>, sepakat untuk mengikatkan diri dalam Perjanjian Kerja Petugas Pendataan Lapangan pada Badan Pusat Statistik Kabupaten Tuban Nomor: <?php echo e($penugasan->no_spk ?: '.......................'); ?>, yang selanjutnya disebut Perjanjian, dengan ketentuan-ketentuan sebagai berikut:</p>
        ...
        <table class="signature-grid">
            <tr>
                <td style="text-align: left; padding-left: 1cm;">
                    ...
                    <p class="text-uppercase"><?php echo e($penugasan->mitra->nama_lengkap); ?></p>
                </td>
                <td style="text-align: right; padding-right: 1cm;">
                    <div style="display: inline-block; text-align: center;">
                        <p class="fw-bold text-uppercase text-center">PIHAK PERTAMA,</p>
                        <div style="height: 2.5cm;"></div>
                        <p class="text-uppercase text-center"><?php echo e($katim->nama_lengkap ?? '.......................'); ?></p>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="page">
        <div class="header text-center">
            ...
            <div class="fw-bold">NOMOR: <?php echo e($penugasan->no_spk ?: '.......................'); ?></div>
        </div>
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                <?php $__currentLoopData = $penugasans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="text-align: left;"><?php echo e($p->nama_kegiatan_full); ?></td>
                    <td>
                        <?php echo e(Carbon\Carbon::parse($p->tgl_mulai)->format('d/m/Y')); ?> s.d <br>
                        <?php echo e(Carbon\Carbon::parse($p->tgl_selesai_target)->format('d/m/Y')); ?>

                    </td>
                    <td><?php echo e($p->volume); ?></td>
                    <td><?php echo e($p->satuan); ?></td>
                    <td class="text-right">Rp <?php echo e(number_format($p->total_honor_tugas, 0, ',', '.')); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="fw-bold text-right">Rp <?php echo e(number_format($totalHonor, 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align: left; background: #f9f9f9;">
                        <i># <?php echo e($totalHonorTerbilang); ?> #</i>
                    </td>
                </tr>
            </tfoot>
        </table>
...
<?php /**PATH /var/www/resources/views/penugasan-mitra/spk.blade.php ENDPATH**/ ?>