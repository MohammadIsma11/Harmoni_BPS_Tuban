                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 border-start border-4 border-primary">
                            ...
                            <div class="mb-0">
                                ...
                                <input type="text" name="sls" id="sls" class="form-control rounded-3 border-0 bg-light p-3 fw-bold shadow-sm" placeholder="Contoh: RT 02 / RW 01" value="{{ old('sls', $report->sls) }}">
                            </div>

                            <input type="hidden" name="lat" id="lat" value="{{ old('lat', $report->lat) }}">
                            <input type="hidden" name="lng" id="lng" value="{{ old('lng', $report->lng) }}">
                        </div>
