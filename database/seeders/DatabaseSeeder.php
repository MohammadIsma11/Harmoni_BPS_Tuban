...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $users = [
            ...
            ['nama_lengkap' => 'Yudhi Prasetyono', 'nip' => '197008101989031001', 'username' => 'yudhip', 'role' => 'Katim', 'team_id' => 7, 'email' => 'yudhi.prasetyono@bps.go.id'],
            ['nama_lengkap' => "Zaidatul Ma'rifah", 'nip' => '197211051994122001', 'username' => 'ifahzm', 'role' => 'Pegawai', 'team_id' => 1, 'email' => 'ifahzm@bps.go.id'],
            ...
            ['nama_lengkap' => 'Ika Rahmawati', 'nip' => '198710192010032001', 'username' => 'ikarahma', 'role' => 'Katim', 'team_id' => 3, 'email' => 'ikarahma@bps.go.id'],
            ['nama_lengkap' => 'Nuzul Djoko Susanto', 'nip' => '197902162002121003', 'username' => 'nuzul.susanto', 'role' => 'Pegawai', 'team_id' => 6, 'email' => 'nuzul.susanto@bps.go.id'],
            ...
            ['nama_lengkap' => 'Respati Yekti Wibowo', 'nip' => '198805112011011014', 'username' => 'respati.wibowo', 'role' => 'Katim', 'team_id' => 2, 'email' => 'respati.wibowo@bps.go.id'],
            ...
            ['nama_lengkap' => 'Mei Fadlillah Ningcahyanti', 'nip' => '199305292016022001', 'username' => 'mei.fadlillah', 'role' => 'Pegawai', 'team_id' => 2, 'email' => 'mei.fadlillah@bps.go.id'],
            ...
            ['nama_lengkap' => 'Rizky Wahyuningsih', 'nip' => '199601032019012001', 'username' => 'rizkyw', 'role' => 'Pegawai', 'team_id' => 1, 'email' => 'rizkyw@bps.go.id'],
            ['nama_lengkap' => 'Nanda Eka Putri R', 'nip' => '199408182019032001', 'username' => 'nanda.ekaputri', 'role' => 'Pegawai', 'team_id' => 7, 'email' => 'nanda.ekaputri@bps.go.id'],
            ...
            ['nama_lengkap' => 'Andik Kusris Tanto', 'nip' => '197208101994011001', 'username' => 'andik.tanto', 'role' => 'Pegawai', 'team_id' => 3, 'email' => 'andik.tanto@bps.go.id'],
            ...
            ['nama_lengkap' => 'Suryo Tri Buwono', 'nip' => '198305312006041009', 'username' => 'suryo.buwono', 'role' => 'Pegawai', 'team_id' => 3, 'email' => 'suryo.buwono@bps.go.id'],
            ...
            ['nama_lengkap' => 'Akhmad Subkhan', 'nip' => '199001132012121002', 'username' => 'subkhan', 'role' => 'Pegawai', 'team_id' => 2, 'email' => 'subkhan@bps.go.id'],
            ['nama_lengkap' => 'Haiza Maulana Arisa Putra', 'nip' => '199812022022031004', 'username' => 'haiza.putra', 'role' => 'Pegawai', 'team_id' => 4, 'email' => 'haiza.putra@bps.go.id'],
            ['nama_lengkap' => 'Nanda Puji Sri Lestari', 'nip' => '199706252022032015', 'username' => 'nanda.lestari', 'role' => 'Pegawai', 'team_id' => 1, 'email' => 'nanda.lestari@bps.go.id'],
            ...
            ['nama_lengkap' => 'Dasriatun', 'nip' => '198304302025212029', 'username' => 'darsriatun-pppk', 'role' => 'Pegawai', 'team_id' => 1, 'email' => 'darsriatun-pppk@bps.go.id'],
            ['nama_lengkap' => 'Zaki Mubarok', 'nip' => '197505092025211022', 'username' => 'zakimubarok-pppk', 'role' => 'Pegawai', 'team_id' => 1, 'email' => 'zakimubarok-pppk@bps.go.id'],
            ['nama_lengkap' => 'Galuh Fianda Fantri', 'nip' => '199602072025212049', 'username' => 'galuhfantri-pppk', 'role' => 'Pegawai', 'team_id' => 6, 'email' => 'galuhfantri-pppk@bps.go.id'],
            
            // Tambahan Pegawai Baru
            ['nama_lengkap' => 'Eko Hardiyanto', 'nip' => '', 'username' => 'eko.hardi', 'role' => 'Pegawai', 'team_id' => 6, 'email' => 'eko.hardi@bps.go.id'],
